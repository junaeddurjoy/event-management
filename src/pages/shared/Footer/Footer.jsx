...
const Footer = () => {
    return (
        <div>
            <footer className="footer footer-center p-10 bg-gradient-to-r from-purple-500 to-pink-500 shadow-lg text-base-content rounded">
                <nav className="grid grid-flow-col gap-4">
                    <a className="link link-hover text-xl text-white">About us</a>
                    <a className="link link-hover text-xl text-white">Contact</a>
                </nav>
                <nav>
                ...
                <aside>
                    <p className='text-white text-md'>Copyright © 2023 - All right reserved by AnimeCon</p>
                </aside>
            </footer>
        </div>
    );
